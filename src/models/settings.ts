...
import defaultSettings, { DefaultSettings } from '@/components/themeColorClient/defaultSettings';
import themeColorClient from '@/components/themeColorClient/themeColorClient';
